...
export default function HeroSection() {
    ...
    return (
        ...
        <div className="relative z-10 max-w-2xl flex flex-col space-y-[64px]">
            ...
            <button
                ...
                className="self-start h-[60px] text-[20px] group relative inline-flex items-center justify-center border-1 border-[#FFFFFF] bg-[#21272E] text-white font-pt text-[16px] rounded-[28px] overflow-hidden px-6 py-2 transition-all duration-800 ease-out cursor-pointer select-none"
            >
                <span
